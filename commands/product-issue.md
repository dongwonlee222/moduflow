...
1. **먼저 물어봅니다 — 이걸 안 고치면 누가 무엇을 못 합니까?** 답을 `## 안 고치면`에 한 문장으로 씁니다. **답이 "아무도 막히지 않는다"이면 이슈를 만들지 않습니다.** 결함을 찾았다는 것과 고쳐야 한다는 것은 다릅니다.
   ...
   그리고 그 답이 목표의 일곱 가지 — **히스토리·메모리·이슈·로드맵·플레이북·프로세스·스킬** — 중 어디를 막는지 말해야 합니다. 어디도 안 막으면 모두플로 일이 아닙니다. 판정 규칙은 `workspace/goal.md`의 「이슈를 거르는 법」에 있습니다.

   모두플로는 이것들을 **보관하고 건네줍니다. 실행은 외부 도구가 합니다.** "실행을 더 잘하게 하자"는 이슈는 여기 것이 아닙니다.
