...
1. **먼저 물어봅니다 — 이걸 안 고치면 누가 무엇을 못 합니까?** 답을 `## 안 고치면`에 한 문장으로 씁니다. **답이 "아무도 막히지 않는다"이면 이슈를 만들지 않습니다.** 결함을 찾았다는 것과 고쳐야 한다는 것은 다릅니다.
   ...
   그리고 그 답이 `workspace/goal.md`의 **"무엇"** 중 어디를 막는지 말해야 합니다. 거기에 안 걸리면 모두플로 일이 아닙니다.

   > ⚠️ 2026-09-07 현재 목표 파일의 "이뤘다고 하려면"이 **비어 있습니다**(사장님이 정하실 것). 그때까지 이 걸러내기는 "무엇"의 한 문장에만 기댑니다.
