...
REQUIRED_FILES = [
    ...
    "templates/workspace/analysis-runs.md",
    "templates/analysis-playbooks/README.md",
    "templates/analysis-playbooks/amount-band.md",
    "templates/analysis-playbooks/charging-speed.md",
    "templates/analysis-playbooks/cpo-change.md",
    "templates/analysis-playbooks/monthly-trend.md",
    "templates/analysis-playbooks/policy-impact.md",
    ...
    "templates/business-plan/business-plan.md",
    "templates/business-plan/executive-summary.md",
    "templates/business-plan/deck-outline.md",
    "templates/business-plan/validation-plan.md",
    "templates/business-plan/issue-candidates.md",
    "templates/business-plan/review-summary.md",
    "templates/business-plan/document-types.md",
    "templates/business-plan/market-entry-analysis.md",
    "templates/business-plan/calculation-model.md",
    "templates/business-plan/source-checklist.md",
    "templates/business-plan/pdf-quality-gate.md",
    "templates/business-plan/writing-style.md",
    ...
    "scripts/project_analysis_run.py",
