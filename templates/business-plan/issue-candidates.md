...
```mermaid
flowchart TD
  H1[Customer has urgent problem] --> I1[Customer interviews]
  H2[Channel can reach buyers] --> I2[Landing page smoke test]
  H3[Solution is feasible] --> I3[MVP PRD]
  H4[Price is acceptable] --> I4[Pricing test]
```
