# 한글 검토 패킷: 081-gpt-5-6-model-tier-guidance
...
- 제목: Issue 081: GPT-5.6 Model Tier Guidance
- 설명: Update ModuFlow's subagent model-tier guidance for the OpenAI GPT-5.6 family while preserving the existing `deep` / `balanced` / `fast` semantic routing model.
...
| 산출물 | 용도 | 원문 | 한글 보기 |
| --- | --- | --- | --- |
| `spec.md` | 스펙 | `specs/081-gpt-5-6-model-tier-guidance/spec.md` | 요약/상세 한글 개요로 대체 |
| `plan.md` | 계획 | `specs/081-gpt-5-6-model-tier-guidance/plan.md` | 요약/상세 한글 개요로 대체 |
| `tasks.md` | 작업 | 없음 | 요약/상세 한글 개요로 대체 |
| `design.md` | 화면/설계 | 없음 | 요약/상세 한글 개요로 대체 |
| `status.md` | 상태/검증 | `specs/081-gpt-5-6-model-tier-guidance/status.md` | 요약/상세 한글 개요로 대체 |
| `review.md` | 리뷰 | `specs/081-gpt-5-6-model-tier-guidance/review.md` | 요약/상세 한글 개요로 대체 |
| `pr.md` | PR 핸드오프 | `specs/081-gpt-5-6-model-tier-guidance/pr.md` | 요약/상세 한글 개요로 대체 |
| `human-review.ko.md` | 한글 검토 패킷 | `specs/081-gpt-5-6-model-tier-guidance/human-review.ko.md` | 가능 |
...
- 보류하면 `product:review 081-gpt-5-6-model-tier-guidance`로 되돌려 수정합니다.
