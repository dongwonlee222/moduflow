...
- [ ] **C1d — projected transition/update routing.** Generalize the shared projected issue evaluation from reconcile to transition and loop-update intents while retaining no-follow guarantees for canonical targets. This closes original C1 Step 4 before C1 is marked complete. Detailed plan: `docs/superpowers/plans/2026-09-01-issue-103-c1d-projected-transition-routing.md`.
