...
- Clarified that every completed ModuFlow action must include a structured Korean-first handoff: next work, reason, concrete next actions, follow-on priority, and exact command when useful.
