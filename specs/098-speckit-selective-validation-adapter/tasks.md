...
- Eight canonical English/Korean requests cover all four functions through adapter, routing integration, and the real pilot path → D1, E1.
- Four disabled/unavailable cases and twelve noncanonical grammar/boundary cases return structured fallback without loading project or template inputs → D1, E1.
