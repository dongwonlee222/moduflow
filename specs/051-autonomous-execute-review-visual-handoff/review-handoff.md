# Review Handoff: 051-autonomous-execute-review-visual-handoff
...
- Input artifacts:
  - `issues/051-autonomous-execute-review-visual-handoff.md`
  - `specs/051-autonomous-execute-review-visual-handoff/spec.md`
  - `specs/051-autonomous-execute-review-visual-handoff/tasks.md`

### Implementation Tasks

- [x] Test: review handoff includes implementation/review subagent sections [files: tests/test_project_execution.py]
- [x] Implementation: add project execution handoff helper [files: scripts/project_execution.py]
...
- Issue drill-down output: `memory/issue-051-autonomous-execute-review-visual-handoff.html`
...
- Include issue drill-down path: `memory/issue-051-autonomous-execute-review-visual-handoff.html`.
