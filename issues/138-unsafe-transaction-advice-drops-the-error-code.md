...
복구 진단이 항상 같은 한 문장만 내놓습니다. — **프로세스**가 막힙니다.

2026-09-07 재판정: **146과 합칠 후보.** 둘 다 "진단이 등급·코드를 버리고
한 덩어리로 나온다"는 같은 병이고, 146이 그 자리(findings 배열)를 만듭니다.
따로 고치면 같은 렌더링 층을 두 번 만듭니다.
