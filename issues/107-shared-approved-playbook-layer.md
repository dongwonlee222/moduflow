...
**플레이북**이 막힙니다 — 목표의 일곱 가지 중 하나입니다.

다만 지금 막히는 사람은 없습니다. 공유할 조직이 아직 없어서입니다. 2026-09-07
재판정: **범위 안이지만 팀 대기.** 닫지 않고 blocked 로 둡니다. 이전 판정
("아무도 막히지 않음")은 플레이북을 목표에서 빠뜨린 기준으로 낸 것이라 버립니다.
